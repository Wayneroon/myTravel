...
*/
	paths:{
		...
		// 'angular': 'http://ajax.googleapis.com/ajax/libs/angularjs/1.5.5/angular.min',
		// 'angular': '../lib/bower_components/angular/angular',
		'angular': '../lib/angular/1.5.6/angular',
		'firebase': '../lib/firebase/firebase',
        'ng-route': '../lib/angular-route',
        'angularFire': '../lib/angularfire/dist/angularfire',
        // 'ngAnimate': 'http://ajax.googleapis.com/ajax/libs/angularjs/1.5.6/angular-animate.min',
        // 'ngAria': 'http://ajax.googleapis.com/ajax/libs/angularjs/1.5.6/angular-aria.min',
        // 'ngMessages': 'http://ajax.googleapis.com/ajax/libs/angularjs/1.5.6/angular-messages.min',
        // 'ngMaterial': '../lib/angular/1.5.6/angular-material.min',
		'ngMaterial': 'http://ajax.googleapis.com/ajax/libs/angular_material/1.0.5/angular-material',
		...
		'ngMessages': '../lib/bower_components/angular-material/angular-material.min',
		// 'ngMaterial': '../lib/angular/1.5.6/angular-material.min',
		'library': '../lib'
	},
...
*/
	shim:{
		...
		'app':{
			deps:['angular','ngMaterial', 'ngMessages']
		},
		'routes':{
			deps:['angular']
		},
...
requirejs( [
	...
	function (text, $, angular) {
		...
		$(document).ready(function () {
			...
			angular.bootstrap(document, ['MyTravelApp']);
